...
Revision ID: 7c1cc00fd071
Revises: 
Create Date: 2023-12-15 14:20:21.738763
...
def upgrade() -> None:
    ...
    sa.Column('status', sa.Enum('NEW', 'IN_PROGRESS', 'FAILED', 'FATAL', 'CANCELED', name='statustaskrosemary'), nullable=False),
    ...
    sa.Column('task_return', sa.JSON(), nullable=True),
